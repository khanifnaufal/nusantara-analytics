...
<template>
  <div class="relative min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-6 md:p-8">
    ...
    <div class="absolute top-1/2 -right-40 w-96 h-96 bg-violet-500/5 rounded-full blur-3xl pointer-events-none"></div>
    <div class="absolute -bottom-40 left-1/3 w-96 h-96 bg-emerald-500/5 rounded-full blur-3xl pointer-events-none"></div>
    ...
    <div class="max-w-7xl mx-auto space-y-8 relative z-10">
      ...
      <header class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-6 border-b border-slate-800/60">
        ...
        <!-- System Status & Clock -->
        <div class="inline-flex items-center gap-3 bg-slate-900/60 border border-slate-850/80 backdrop-blur-md py-2 px-4 rounded-xl text-xs font-semibold text-slate-300 self-start sm:self-auto shadow-sm">
